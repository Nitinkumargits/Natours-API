...
const showAlert = function (type, msg) {
  let time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
  hideAlert();
...
const bookTour = async tourId => {
  ...
  try {
    ...
    const session = await (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId));
...
exports.forgotPassword_funtion = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
/* eslint-disable */
...
const forgotPassword_funtion = async email => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, _alerts.showAlert)('success', 'Kindly check your Email');
    }
  } catch (err) {
    var _err$response;
...
exports.forgotPassword_funtion = forgotPassword_funtion;
...
exports.resetPassword_func = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
/* eslint-disable */
...
const resetPassword_func = async (password, passwordConfirm, token) => {
  try {
    ...
    const message = (err === null || err === void 0 || (_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Something went wrong. Try again.';
    (0, _alerts.showAlert)('error', message);
  }
};
exports.resetPassword_func = resetPassword_func;
